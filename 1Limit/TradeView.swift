...
struct TradeView: View {
  ...
  private func createLimitOrder() {
    ...
    if let calculation = currentSwapCalculation {
      ...
      print(
        "  From: \(calculation.fromAmount) \(calculation.fromToken) (~\(calculation.formattedFromValue))"
      )
      print(
        "  To: \(calculation.toAmount) \(calculation.toToken) (~\(calculation.formattedToValue))")
