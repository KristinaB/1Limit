                ...
                VStack(spacing: 24) {
                    ...
                    AppCard {
                        VStack(spacing: 20) {
                            ...
                            Text(
                                "You need to create, import, or use a test wallet before you can start trading."
                            )
                            .secondaryText()
                    ...
                    VStack(spacing: 24) {
                            ...
                            VStack(spacing: 16) {
                                ZStack {
                                    Circle()
                                        ...
                                        .shadow(
                                            color: Color.blue.opacity(0.2), radius: 8, x: 0, y: 4
                                        )
                                        .shadow(
                                            color: Color.black.opacity(0.3), radius: 2, x: 0, y: 1)
                                ...
                                VStack(spacing: 16) {
                                    ...
                                    VStack(spacing: 8) {
                                        ...
                                        HStack {
                                            ...
                                            Text(
                                                String(
                                                    format: "%.6f %@/%@", result.userPrice, toToken,
                                                    fromToken)
                                            )
                                            .captionText()
                                            .fontWeight(.medium)
                                        ...
                                        HStack {
                                            ...
                                            Text(
                                                String(
                                                    format: "%.6f - %.6f",
                                                    result.recommendedRange.lowerBound,
                        ...
                        VStack(spacing: 12) {
                            if orderService.isExecuting {
                                ...
                                VStack(spacing: 12) {
                                    SecondaryButton(
                                        "⚠️ Place Order Anyway", icon: "exclamationmark.triangle"
                                    ) {
                                        Task {
                                            await placeOrder()
                                        }
